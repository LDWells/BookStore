...
public class AuthorDAO extends HenryDAO {
	
	   enum SQL{
		   
	   	   SEARCH_BY_AUTHOR("SELECT AUTHOR_FIRST, AUTHOR_LAST From henry_author"),
	   	   
	   	   SELECT_BOOK_FROM_AUTHOR("SELECT TITLE FROM henry_book hb \r\n"
	   	   		+ "JOIN henry_wrote hw ON hb.BOOK_CODE = hw.BOOK_CODE\r\n"
	   	   		+ "JOIN henry_author ha ON ha.AUTHOR_NUM = hw.AUTHOR_NUM\r\n"
	   	   		+ "WHERE AUTHOR_FIRST = ?"),
	   ...
	   public List<Book> searchByAuthor()
	   {
		   ...
		   List<Book> list = new ArrayList<>();
	        ...
	        try {
	            ...
	            resultSet = statement.executeQuery(SQL.SEARCH_BY_AUTHOR.getQuery());
	   ...
	   public List<Book> bookFromAuthor(String name)
	   {
		   List<Book> list = new ArrayList<>();
	        
	        try {
	            this.connect();
	            preparedStatement = connection.prepareStatement(SQL.SELECT_BOOK_FROM_AUTHOR.getQuery());
